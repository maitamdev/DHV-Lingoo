    ...
    return (
        <section aria-label='Hero' className="relative min-h-[90vh] sm:min-h-screen flex items-center overflow-hidden pt-24 sm:pt-28 pb-12 sm:pb-0 overflow-x-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                ...
                <div className="absolute top-20 sm:top-40 right-4 sm:right-10 w-48 sm:w-72 h-48 sm:h-72 bg-blue-300 dark:bg-blue-900 rounded-full mix-blend-multiply dark:mix-blend-screen blur-xl opacity-40 animate-blob animation-delay-2000" />
                <div className="absolute -bottom-8 left-1/4 sm:left-1/3 w-48 sm:w-72 h-48 sm:h-72 bg-teal-300 dark:bg-teal-900 rounded-full mix-blend-multiply dark:mix-blend-screen blur-xl opacity-40 animate-blob animation-delay-4000" />
            </div>
                    ...
                    <div className="space-y-5 sm:space-y-8 text-center md:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
                            <Button
                                size="lg"
                                asChild
                                className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-500/90 hover:to-blue-600/90 shadow-lg shadow-cyan-500/25 text-sm sm:text-base h-11 sm:h-12 px-6 sm:px-8"
                            >
                                <Link href="/register">
                                    Học miễn phí
                            ...
                            <Button
                                ...
                                variant="outline"
                                asChild
                                className="text-sm sm:text-base h-11 sm:h-12 px-6 sm:px-8 group"
                            >
                                <Link href="/courses">
                        ...
                        <div className="flex items-center gap-4 pt-2 sm:pt-4 justify-center md:justify-start">
                            <div className="flex -space-x-3">
                                {[1, 2, 3].map((i) => (
                                    <div
                                        key={i}
                                        className="h-8 w-8 sm:h-10 sm:w-10 rounded-full border-2 border-background overflow-hidden"
                                    >
                                        <Image
