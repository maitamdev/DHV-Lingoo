            ...
            <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="w-10 h-10 bg-white border border-gray-200 shadow-sm flex items-center justify-center text-gray-400 hover:text-blue-600 hover:border-blue-300 transition-all">
                ...
                <div className="flex flex-col xl:flex-row gap-5">
                    ...
                    <div className="flex-1 min-w-0 space-y-5">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                            ...
                            <div className={`lg:col-span-3 relative bg-gradient-to-br ${levelInfo.color} text-white p-6 sm:p-7 overflow-hidden shadow-lg`}>
                                ...
                                <div className="absolute left-0 bottom-0 w-full h-px bg-gradient-to-r from-white/20 via-white/5 to-transparent" />
                            ...
                            <div className="lg:col-span-2 grid grid-cols-2 lg:grid-cols-1 gap-4">
                                ...
                                <div className="bg-white border border-gray-200 border-l-4 border-l-orange-500 p-5 shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    {longestStreak > 0 && (
                                        <p className="text-[10px] text-gray-400 mt-1">Kỷ lục: {longestStreak} ngày</p>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <MiniStat icon={<Clock className="h-4 w-4" />} label="Mục tiêu/ngày" value={`${dailyTime}m`} accent="border-t-cyan-500" />
                            <MiniStat icon={<TrendingUp className="h-4 w-4" />} label="Level" value={level} accent="border-t-blue-500" />
                            <MiniStat icon={<Calendar className="h-4 w-4" />} label="Tham gia" value={daysSinceJoined === 0 ? "Hôm nay" : `${daysSinceJoined}d`} accent="border-t-indigo-500" />
                        </div>
                        ...
                        <div className="bg-white border border-gray-200 shadow-sm p-5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-1">
                                ...
                                <InfoItem label="Vai trò" value={
                                    profile?.role === "student" ? "Học viên" : profile?.role === "teacher" ? "Giảng viên" : profile?.role === "admin" ? "Quản trị" : "Học viên"
                                } />
                    ...
                    <div className="w-full xl:w-[300px] flex-shrink-0 space-y-5">
                            ...
                            {userRank >= 0 && (
                                <div className="mt-4 pt-3 border-t border-gray-100 text-center">
                                    <p className="text-xs text-gray-400">
                                        Hạng của bạn: <span className="font-mono font-bold text-blue-600">#{userRank + 1}</span>
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className={`relative overflow-hidden bg-gradient-to-br ${levelInfo.color} shadow-lg`}>
                            ...
                            <div className="absolute left-4 bottom-4 w-12 h-12 border border-white/10 rotate-12" />
    ...
    return (
        <div className="bg-white border border-gray-200 shadow-sm p-5 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2.5 mb-4">
                <div className={`w-7 h-7 border flex items-center justify-center ${iconBg}`}>
                    {icon}
                </div>
            ...
            {items.length > 0 ? (
                <div className="flex flex-wrap gap-2">
                    {items.map((item) => (
                        <span key={item} className={`px-3 py-1.5 text-xs font-semibold border ${tagColor}`}>
                            {item}
                        </span>
                    ))}
                </div>
